...
public class BiggestNumber {
    public static void main(String[] args) {
        ...
        while(num++ < 5){ // this loop will run for 5 times
            ...
            if(inputNum < min){
                min = inputNum;// // if the new number from the console is bigger than our current biggest number, we found a new max number and should reassign it to the variable
            }
